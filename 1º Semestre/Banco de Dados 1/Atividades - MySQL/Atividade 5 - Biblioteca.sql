create table Tipo_Usuario (tipo_user int not null primary key, 
...
insert into Usuario values (1, "0157/12-3", "Vinicius Ramon Da Costa Reis",	"Rua Antônio Menardi, 683 Jd. Gustavo Picinini", "+55 19 99406-3541",1);
insert into Usuario values (2, "0160/12-3", "Artur Breeden Harlan Wehausen", "Avenida Três, 531 Jardim Residencial Village", "+55 19 94241-7832",2);
insert into Usuario values (3, "0128/12-3", "Cláudio Chester Backhaus",	"Rua Deputado Octávio Lopes, 2015 Centro", "+55 19 92223-1769",3);
insert into Usuario values (4, "0126/12-3", "César Compton Riecke",	"Rua Roque Orlando de Souza, 201 Jardim Cidade Universitária I", "+55 19 91480-6552",4);
insert into Usuario values (5, "0127/12-3", "Ernesto Oakley Grossenbacher",	"Rua Emílio Bortolan, 422 Parque das Nações", "+55 19  91930-5565",1);
insert into Usuario values (6, "0150/12-3", "Filipe Clifford Lindemann", "Rua Gilmar Luiz Sebastião, 513 Jardim Clube do Bosque", "+55 19 93955-4721",2);
insert into Usuario values (7, "0151/12-3", "Florencio Prescott Harrington Baumeister",	"Rua Brigadeiro Vicente Faria Lima, 752 Centro", "+55 19 94845-7258",3);
insert into Usuario values (8, "0152/12-3", "Flávio Clapham Goldmann",	"Rua Armando Pereira, 716 Jd. Jardim Dibi", "+55 19 96894-0885",4);
insert into Usuario values (9, "0153/12-3", "Júlio Clapham Stansfield Brase", "Rua João Poletti, 666 Conjunto Habitacional Ferdinando Marchi", "+55 22 90617-5099",1);
insert into Usuario values (10, "0154/12-3", "Luis Appleton Riehl", "Avenida Joaquim Lopes Aguila, 209 Vila São Jorge", "+55 76 98361-5221",2);
insert into Usuario values (11, "0155/12-3", "Victorino Ridley Göbel", "Avenida Dom João Bosco, 841 Vila Rezende", "+55 27 94578-0633",3);
insert into Usuario values (12, "0156/12-3", "Andréia Ridley Scarbrough Staudte", "Rua Mário Sérgio Baltieri, 632 Água Branca", "+55 47 93787-4904",4);
insert into Usuario values (13, "0158/12-3", "Clara Goody Oestreich", "Rua Santos Dumont, 457 Centro", "+55 19 98511-8426",1);
insert into Usuario values (14, "0159/12-3", "Elba Harley Singer", "Rua Santos Dumont, 457 Centro", "+55 19 90718-1350",2);
insert into Usuario values (15, "0120/12-3", "Gertrudes Westbrook Weisgerber", "Rua Santos Dumont, 682 Centro", "+55 19 99585-7242",3);
insert into Usuario values (16, "0121/12-3", "Helena Anderton Kallenbach", "Rua Capiberibe, 774 Vila Dainese", "+55 19 96356-4572",4);
insert into Usuario values (17, "0122/12-3", "Lídia Manley Hettinger", "Avenida Doosan, 775 Parque São Jerônimo", "+55 19 99059-9825",1);
insert into Usuario values (18, "0123/12-3", "Maria Garfield Schlumberger", "Rua João Scarazato, 386 Santa Cruz", "+55 19 93353-7590",2);
insert into Usuario values (19, "0124/12-3", "Salete Tindall Hector", "Rua Camanducaia, 932 Vila Dainese", "+55 19 97483-3450",3);
insert into Usuario values (20, "0125/12-3", "Teresa Brady Kinzel", "Rua Xingú, 552 Jardim São Roque", "+55 19 91517-2712",4);
