...
select fornecedor.nome_fornecedor as nome, produtos.descricao as produto from fornecedor,produtos;
select fornecedor.nome_fornecedor as nome, compras.dt_compra as dia from fornecedor,compras where fornecedor.id_fornecedor = compras.id_fornecedor order by dia;
select * from fornecedor;
select * from compras;
select * from itens_da_compra;
select * from produtos;
select fornecedor.nome_fornecedor as nome, compras.dt_compra as dia, produtos.descricao as produto 
from fornecedor,compras,produtos 
where fornecedor.id_fornecedor = compras.id_fornecedor and fornecedor.id_fornecedor = 2 order by dia;
...
select produtos.qtde_estoque as qtde_minima, produtos.descricao as nome from produtos where produtos.qtde_estoque < 100;